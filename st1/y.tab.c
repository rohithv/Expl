...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 25 "expr3.y" /* yacc.c:1646  */
    {
				(yyval) = (yyvsp[0]);
				//printf("Answer : %d\n",evaluate($1));
				output(codeGen((yyvsp[-1])));
				freeReg();
				//exit(1);
			}
